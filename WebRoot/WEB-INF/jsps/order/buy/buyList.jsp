...
<script type="text/javascript" src="buyList.js">
</script>
			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td> 
							<s:select list="@cn.itcast.invoice.invoice.order.vo.OrderModel@buyTypeMap" headerKey="-1" headerValue="---请-选-择---" cssStyle="113px"></s:select>
						</td>
						<td>下单人:</td>
			...
			<div class="square-order">
				...
				<s:iterator value="orderList">
					<tr align="center" bgcolor="#FFFFFF">
						...
						<td>
							<s:a action="order_buyDetailList" cssClass="xiu">
