...
<script type="text/javascript" src="assignTaskList.js">
</script>
						...
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>
								<span style="line-height:12px; text-align:center;"> 
									<s:if test="@cn.itcast.invoice.invoice.order.business.ebo.OrderEbo@taskTypesSet.contains(type)">
										<img src="images/icon_3.gif" /> 
										<s:a action="task_assignTaskDetail" cssClass="xiu">
