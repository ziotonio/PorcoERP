				...
				<table width="100%">
					<tr>
						<td width="50%" align="center">
							<s:if test="om.type.equals(@cn.itcast.invoice.invoice.order.vo.OrderModel@ORDER_TYPE_OF_BUY_BUYING)">
							<s:a action="task_completeTask" cssStyle="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
								<s:param name="om.uuid" value="om.uuid"/>
								结&nbsp;&nbsp;单
							</s:a>
							</s:if>
							<s:else>
								<a href="javascript:void(0)" onclick="history.back()" style="color:#f00;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
									已结单
								</a>
							</s:else>
						</td>
