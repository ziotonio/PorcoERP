			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>登录时间</td>
						<td>
							<input type="text" value="${eqm.lastLoginTimeView}" size="14" onfocus="c.showMoreDay=false;c.show(this);" readonly="true"/>
							<s:hidden name="eqm.lastLoginTime"/>
						</td>
						<td>登录时间</td>
						<td>
							<input type="text" value="${eqm.lastLoginTime2View}" size="14" onfocus="c.showMoreDay=false;c.show(this);" readonly="true"/>
							<s:hidden name="eqm.lastLoginTime2"/>
						</td>
						<td>部门名称</td>
						<td>
							<s:select name="eqm.dm.uuid" list="depList" listKey="uuid" listValue="name" cssClass="kuan" headerKey="-1" headerValue="----请-选-择----"></s:select>
						</td>
